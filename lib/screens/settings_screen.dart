...
// class that builds the Settings Screen
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  // method, that loads the current Settings from Shared Preferences
  ...
  // method, that saves the entered Settings to Shared Preferences
